...
import ANNIEMUSIC.modules.sql.locks_sql as sql
from ANNIEMUSIC import JARVIS, LOGGER, dispatcher
from ANNIEMUSIC.modules.connection import connected
from ANNIEMUSIC.modules.disable import DisableAbleCommandHandler
from ANNIEMUSIC.modules.helper_funcs.alternate import send_message, typing_action
from ANNIEMUSIC.modules.helper_funcs.chat_status import (
    can_delete,
    is_bot_admin,
    is_user_admin,
    user_admin,
...
from ANNIEMUSIC.modules.log_channel import loggable
from ANNIEMUSIC.modules.sql.approve_sql import is_approved

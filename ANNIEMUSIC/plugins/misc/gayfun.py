...
def generate_gay_response(gay_percentage):
    ...
    if gay_percentage < 30:
        return "You're straight as an arrow. 🏳️‍🌈 @Kitttxupdates"
    elif 30 <= gay_percentage < 70:
        return "You might have a bit of a rainbow in you. 🌈 @Kittyxupdates"
    else:
        return "You're shining with rainbow colors! 🌟🏳️‍🌈@kittyxupdates"

...
START_IMG_URLS = "https://telegra.ph/file/3eb5af1f3c31bf68073f6.jpg"
    ...
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/KittyxMusic_bot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
